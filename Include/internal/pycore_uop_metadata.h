...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_CALLABLE_FUNCTION] = HAS_ARG_FLAG | HAS_EXIT_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_GUARD_CALLABLE_FUNCTION] = {
        .best = { 0, 0, 0, 0 },
        .entries = {
            { 0, 0, _GUARD_CALLABLE_FUNCTION_r00 },
            { -1, -1, -1 },
            { -1, -1, -1 },
            { -1, -1, -1 },
        },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_GUARD_CALLABLE_FUNCTION_r00] = _GUARD_CALLABLE_FUNCTION,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_GUARD_CALLABLE_FUNCTION] = "_GUARD_CALLABLE_FUNCTION",
    [_GUARD_CALLABLE_FUNCTION_r00] = "_GUARD_CALLABLE_FUNCTION_r00",
